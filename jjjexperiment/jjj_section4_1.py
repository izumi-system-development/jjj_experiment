...
import jjjexperiment.jjj_section4_3_a as rac_spec
...
# ルームエアコンディショナー付温水床暖房
import jjjexperiment.jjj_section4_8 as racfh
...
def get_E_E_H_d_t(region, sol_region, A_A, A_MR, A_OR, A_env, mu_H, mu_C, Q, type, input_C_af_H, input_C_af_C, 
                  H_A=None,
                  spec_MR=None,
    ...
    E_E_hs_d_t = calc_E_E_hs_d_t(region, A_A, A_MR, A_OR, A_env, mu_H, mu_C, Q, H_A, spec_MR, spec_OR, spec_HS, mode_MR, mode_OR, CG,
                                 L_T_H_d_t_i, L_T_CS_d_t_i, L_T_CL_d_t_, type, input_C_af_H, input_C_af_C)
...
def calc_E_E_hs_d_t(type,region, A_A, A_MR, A_OR, A_env, mu_H, mu_C, Q, H_A, spec_MR, spec_OR, spec_HS, mode_MR, mode_OR, CG,
    ...
    """
    if H_A is not None:
        return calc_E_E_H_hs_A_d_t(type,A_A, A_MR, A_OR, A_env, mu_H, mu_C, Q, H_A, L_T_H_d_t_i, L_T_CS_d_t_i, L_T_CL_d_t_i, region, type, input_C_af_H, input_C_af_C)
...
def calc_E_E_H_hs_A_d_t(type,A_A, A_MR, A_OR, A_env, mu_H, mu_C, Q, H_A, L_H_d_t_i, L_CS_d_t_i, L_CL_d_t_i, q_hs_H_d_t, region, input_C_af_H, input_C_af_C):
    ...
    if H_A['EquipmentSpec'] == '入力しない':
        ...
        P_fan_rtd_H = dc_spec.get_P_fan_rtd_H(V_fan_rtd_H)  # NOTE: 変更中
...
def calc_E_UT_H_d_t__modeA(H_A, A_A, A_MR, A_OR, A_env, mu_H, mu_C, Q, region, L_H_d_t_i, L_CS_d_t_i, L_CL_d_t_i, type, input_C_af_H, input_C_af_C):
    """暖房設備の未処理暖房負荷の設計一次エネルギー消費量相当値（MJ/h）(13)を取得する
...
def calc_E_E_C_d_t(region, A_A, A_MR, A_OR, A_env, mu_H, mu_C, Q, q_hs_C_d_t, type, input_C_af_H, input_C_af_C, C_A=None, C_MR=None, C_OR=None, L_H_d_t=None,
    ...
    """
    return calc_E_E_C_hs_d_t(region, A_A, A_MR, A_OR, A_env, mu_H, mu_C, Q, q_hs_C_d_t, C_A, C_MR, C_OR, L_H_d_t, L_CS_d_t, L_CL_d_t, type, input_C_af_H, input_C_af_C)
...
def calc_E_E_C_hs_d_t(type, region, A_A, A_MR, A_OR, A_env, mu_H, mu_C, Q, C_A, C_MR, C_OR, L_H_d_t, L_CS_d_t, L_CL_d_t, q_hs_C_d_t, input_C_af_H, input_C_af_C):
    ...
    if C_A is not None:
        ...
        if C_A['EquipmentSpec'] == '入力しない':
            ...
            P_fan_rtd_C = dc_spec.get_P_fan_rtd_C(V_fan_rtd_C)  # NOTE: 変更中
...
def calc_E_UT_C_d_t(region, A_A, A_MR, A_OR, A_env, mu_H, mu_C, Q, C_A, C_MR, C_OR, L_H_d_t, L_CS_d_t, L_CL_d_t, mode_C, type, input_C_af_H, input_C_af_C):
